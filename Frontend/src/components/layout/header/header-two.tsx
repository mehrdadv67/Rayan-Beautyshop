      ...
      <div className='fixed z-20 w-full h-16 px-4 text-gray-700 transition duration-200 ease-in-out bg-white innerSticky body-font sm:h-20 lg:h-24 ltr:lg:pr-6 rtl:lg:pl-6'>
        <div className='flex items-center justify-between mx-auto max-w-[1920px] h-full w-full'>
          ...
          <div className='flex items-center'>
            <div className='ltr:md:mr-5 rtl:md:ml-5 ltr:xl:mr-8 rtl:xl:ml-8 ltr:2xl:mr-10 rtl:2xl:ml-10'>
              <LanguageSwitcher />
            </div>
            <div className='items-center justify-end flex-shrink-0 hidden md:flex gap-x-6 lg:gap-x-5 xl:gap-x-8 2xl:gap-x-10'>
              <button
